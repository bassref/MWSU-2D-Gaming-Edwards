var playState2 = {
    ...
    create: function() { 
		...
		this.music = game.add.audio('music2'); // Add the music
        ...
        this.player = game.add.sprite(game.width/4, game.height/4, 'player');
        ...
        this.scoreLabel = game.add.text(30, 30, 'score: ', { font: '18px Arial', fill: '#ffffff' });
