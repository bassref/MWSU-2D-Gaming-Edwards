var mainState = {
    ...
    preload: function() {
        game.load.image('player', 'assets/someguy.png');
        game.load.image('wallV', 'assets/wallVertical.png');
        game.load.image('wallH', 'assets/wallHorizontal.png');
        game.load.image('diamond', 'assets/diamond.png');
        game.load.image('enemy', 'assets/plantThing.gif');
    },
   ...
   checkOverlap: function(spriteA, spriteB) {
	...
	playerDie: function() {
		...
		{
			this.deathCount += 1;
			this.deathLabel.text = "Deaths: " + this.deathCount;
			this.prevE = this.currentE;
			this.overlap = true;
		}
